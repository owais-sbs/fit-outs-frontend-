...
import { ZIndexLayer as RechartsZIndexLayer } from "recharts";

const ZIndexLayer = RechartsZIndexLayer as React.ComponentType<
  React.PropsWithChildren<{ zIndex: number }>
>;
