...
export const SC_STATUS_BADGE = {
  ...
  UNDER_REVIEW: "bg-violet-500/15 text-violet-800 border-none",
  ISSUED: "bg-sky-500/15 text-sky-800 border-none",
  PAYABLE: "bg-teal-500/15 text-teal-800 border-none",
  HELD: "bg-amber-500/15 text-amber-800 border-none",
  ELIGIBLE_FOR_RELEASE: "bg-lime-500/15 text-lime-800 border-none",
  APPROVED_FOR_RELEASE: "bg-emerald-500/15 text-emerald-800 border-none",
  RELEASED: "bg-slate-500/15 text-slate-700 border-none",
  AWARDED: "bg-emerald-500/15 text-emerald-700 border-none",
  REGRET: "bg-amber-500/15 text-amber-900 border-none",
  INVITED: "bg-slate-500/15 text-slate-700 border-none",
  VIEWED: "bg-sky-500/15 text-sky-700 border-none",
...
export const SC_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Awards & contracts", href: ROUTES.SUBCONTRACTOR.AWARD_PACKS, icon: Stamp, roles: [SC_ROLES.ADMIN] },
