...
export const ROUTES = {
  ...
  FINANCE: {
    ...
    PROJECT_COMPLETION: "/finance/projects/:projectId/completion",
    PROJECT_PNL: "/finance/projects/:projectId/pnl",
    PNL: "/finance/pnl",
  ...
  CLIENT: {
    ...
    VARIATIONS: "/client/variations",
    PROJECT_VARIATION_DETAIL: "/client/projects/:projectId/variations/:uuid",
  ...
  SITE_ENGINEER: {
    ...
    SITE_VISITS: "/site-engineer/site-visits",
    SITE_VISIT_REPORT: "/site-engineer/site-visits/:visitId/report",
    COMMUNICATIONS: "/site-engineer/communications",
    TERMS: "/site-engineer/terms",
  },
};
