export const ROUTES = {
  ...
  ADMIN: {
    ...
    DESIGN_REQUESTS: "/admin/design-workflow/requests",
    DESIGN_IN_PROGRESS: "/admin/design-workflow/in-progress",
    DESIGN_INTERNAL_REVIEW: "/admin/design-workflow/internal-review",
    DESIGN_UPLOAD: "/admin/design-workflow/upload",
    DESIGN_CLIENT_APPROVAL: "/admin/design-workflow/client-approval",
    DESIGN_REVISIONS: "/admin/design-workflow/revisions",
    DESIGN_COMPLETED: "/admin/design-workflow/completed",
